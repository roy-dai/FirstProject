    ...
    <div>
        <div id="nav" class="nav"> 
            <ul> 
                ...
                <li onmouseover="showsub(this)" onmouseout="hidesub(this)"><a href="#">各區廠商登記數量</a> 
                    <ul> 
        		...
        		<div id="Intro">
	        		...
	        		<div style="margin-left:350px;">
	        			<a style="margin:auto;border:1px solid black;background:#CC6600;text-align:center;color:white;height:30px">聯繫或贊助我們</a>
	        		</div>
        		</div>
                <div class="bar1">
                    <label >請輸入走道寬度</label>
                ...
                <div class="bar2">
                    ...
                    <input class="h" id="hA" type="text" value="500">
                    <input class="w" id="wA" type="text" value="200">
                    <br>
                    <label class="la">B區長,寬</label>
                    <input class="h" id="hB" type="text" value="500">
                    <input class="w" id="wB" type="text" value="200">
                    <br>
                    <label class="la">C區長,寬</label>
                    <input class="h" id="hC" type="text" value="220">
                    <input class="w" id="wC" type="text" value="180">
                    <br>
                    <label class="la">D區長,寬</label>
                    <input class="h" id="hD" type="text" value="70">
                    <input class="w" id="wD" type="text" value="800">
                    <br>
                    <label class="la">E區長,寬</label>
                    <input class="h" id="hE" type="text" value="500">
                    <input class="w" id="wE" type="text" value="200">
                    <br>
        ...
        <div class="outside">
            ...
            <div id="dinning"><i class="fas fa-utensils"></i><h3 style="padding: 10px;">Dinning and Sitting</h3><i class="fas fa-utensils"></i><br>
                <i class="fas fa-chair"></i><i class="fas fa-chair"></i><i class="fas fa-chair"></i><i class="fas fa-chair"></i>
                <i class="fas fa-chair"></i><i class="fas fa-chair"></i><i class="fas fa-chair"></i><i class="fas fa-chair"></i>
                <br>
                <hr>
                <i class="fas fa-chair"></i><i class="fas fa-chair"></i><i class="fas fa-chair"></i><i class="fas fa-chair"></i>
