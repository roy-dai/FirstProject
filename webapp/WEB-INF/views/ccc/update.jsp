...
<header class="main-header">
	...
	<div class="side">
		...
		<div class="login1">
			<div class="login">
				<form class="form" action="../CCC_UPDATELMPL" method="POST"
					enctype="multipart/form-data">
					<h2>修改商品</h2>
					<div class="group">
						<label for="user_name">商品名稱</label> <input type="text"
							name="account" id="user_name" class="user_name"
							style="font-size: 16px" placeholder="${A3}">
					</div>
					<div class="group">
						<label for="user_pwd">價格</label> <input type="text" name="pwd"
							id="user_pwd" class="user_pwd" style="font-size: 16px" placeholder="${A4}">
					</div>
					<div class="group">
						...
						<%for (int v=0;v<names1;v++){ %>
							<label> <input type="checkbox" name="hobby" value="<%=names2.get(v) %>" checked/> <span><%=names2.get(v) %></span></label>
							<%}%>
						</div>
						<div class="group">
