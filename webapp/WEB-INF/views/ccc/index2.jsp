				...
				<div class="products-row">
					...
					<div class="col-xs-6 col-sm-4 product-grids">
						<div class="flip-container">
							<div class="flipper agile-products">
								<div class="front">
									<img src='../nightMarket3/images/ccc/<%=c_image.get(v * 5)%>'
						...
						<div class="flip-container">
							<div class="flipper agile-products">
								<div class="front">
									...
									<img src='../nightMarket3/images/ccc/<%=c_image.get((v * 5) + 1)%>'
										class="img-responsive" alt="img">
								</div>
								<div class="back">
					...
					<div class="col-xs-6 col-sm-4 product-grids">
						<div class="flip-container">
							<div class="flipper agile-products">
								<div class="front">
									<img src='../nightMarket3/images/ccc/<%=c_image.get((v * 5) + 2)%>'
										class="img-responsive" alt="img">
									<div class="agile-product-text">
						...
						<div class="flip-container flip-container1">
							<div class="flipper agile-products">
								<div class="front">
									...
									<img src='../nightMarket3/images/ccc/<%=c_image.get((v * 5) + 3)%>'
										class="img-responsive" alt="img">
								</div>
								<div class="back">
					...
					<div class="col-xs-6 col-sm-6 product-grids">
						<div class="flip-container flip-container1">
							<div class="flipper agile-products">
								<div class="front">
									<img src='../nightMarket3/images/ccc/<%=c_image.get((v * 5) + 4)%>'
										class="img-responsive" alt="img">
									<div class="agile-product-text">
					...
					<div class="col-xs-6 col-sm-4 product-grids">
						<div class="flip-container">
							<div class="flipper agile-products">
								<div class="front">
									<img src='../nightMarket3/images/ccc/<%=c_image.get((a * 5))%>'
										class="img-responsive" alt="img">
									<div class="agile-product-text">
						...
						<div class="flip-container">
							<div class="flipper agile-products">
								<div class="front">
									...
									<img src='../nightMarket3/images/ccc/<%=c_image.get((a * 5) + 1)%>'
										class="img-responsive" alt="img">
								</div>
								<div class="back">
					...
					<div class="col-xs-6 col-sm-4 product-grids">
						<div class="flip-container">
							<div class="flipper agile-products">
								<div class="front">
									<img src='../nightMarket3/images/ccc/<%=c_image.get((a * 5) + 2)%>'
										class="img-responsive" alt="img">
									<div class="agile-product-text">
						...
						<div class="flip-container flip-container1">
							<div class="flipper agile-products">
								<div class="front">
									...
									<img src='../nightMarket3/images/ccc/<%=c_image.get((a * 5) + 3)%>'
										class="img-responsive" alt="img">
								</div>
								<div class="back">
