...
<!-- 						</div>  -->
	...
	<!-- products -->
				...
				String Foodstall =(String) request.getAttribute("Foodstall");
					...
					<div class="col-xs-6 col-sm-4 product-grids">
						<div class="flip-container">
							<div class="flipper agile-products">
								<div class="front">
									<img src='../images/ccc/<%=c_image.get(v * 5)%>'
								...
								<div class="back">
									<h4><%=Foodstall %><br> <%=c_name.get(v * 5)%></h4>
									<p><%=type.get(v * 5)%></p>
									<h6>
					...
					<div class="col-xs-6 col-sm-4 product-grids">
						<div class="flip-container">
							<div class="flipper agile-products">
								...
								<div class="back">
									<h4><%=Foodstall %><br> <%=c_name.get((v * 5) + 1)%></h4>
									<p><%=type.get(v * 5+1)%></p>
									<h6>
					...
					<div class="col-xs-6 col-sm-4 product-grids">
						<div class="flip-container">
							<div class="flipper agile-products">
								...
								<div class="back">
									<h4><%=Foodstall %><br> <%=c_name.get((v * 5) + 2)%></h4>
									<p><%=type.get(v * 5+2)%></p>
									<h6>
					...
					<div class="col-xs-6 col-sm-6 product-grids">
						<div class="flip-container flip-container1">
							<div class="flipper agile-products">
								...
								<div class="back">
									<h4><%=Foodstall %><br> <%=c_name.get((v * 5) + 3)%></h4>
									<p><%=type.get(v * 5+3)%></p>
									<h6>
					...
					<div class="col-xs-6 col-sm-6 product-grids">
						<div class="flip-container flip-container1">
							<div class="flipper agile-products">
								...
								<div class="back">
									<h4><%=Foodstall %><br> <%=c_name.get((v * 5) + 4)%></h4>
									<p><%=type.get(v * 5+4)%></p>
									<h6>
					...
					<div class="col-xs-6 col-sm-4 product-grids">
						<div class="flip-container">
							<div class="flipper agile-products">
								...
								<div class="back">
									<h4><%=Foodstall %><br> <%=c_name.get((a * 5))%></h4>
									<p><%=type.get(a * 5)%></p>
									<h6>
					...
					<div class="col-xs-6 col-sm-4 product-grids">
						<div class="flip-container">
							<div class="flipper agile-products">
								...
								<div class="back">
									<h4><%=Foodstall %><br> <%=c_name.get((a * 5) + 1)%></h4>
									<p><%=type.get(a * 5+1)%></p>
									<h6>
					...
					<div class="col-xs-6 col-sm-4 product-grids">
						<div class="flip-container">
							<div class="flipper agile-products">
								...
								<div class="back">
									<h4><%=Foodstall %><br> <%=c_name.get((a * 5) + 2)%></h4>
									<p><%=type.get(a * 5+2)%></p>
									<h6>
					...
					<div class="col-xs-6 col-sm-6 product-grids">
						<div class="flip-container flip-container1">
							<div class="flipper agile-products">
								...
								<div class="back">
									<h4><%=Foodstall %><br> <%=c_name.get((a * 5) + 3)%></h4>
									<p><%=type.get(a * 5+3)%></p>
									<h6>
			...
			<div class="spldishes-agileinfo">
				...
				<div class="col-md-9 spldishes-grids">
					...
					<a href="../CCC_BB/" class="item g1"> 
						<img class="lazyOwl" src="../images/ccc/images/a1.png" title="Our latest gallery"
							alt="" />
