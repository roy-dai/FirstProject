...
<!-- 						</div>  -->
	...
	<!-- products -->
				...
				<%
				int list_size = (int) request.getAttribute("list_size");
				...
				ArrayList Foodstall = new ArrayList((ArrayList) request.getAttribute("Foodstall"));/*編號*/
				...
				<div class="products-row">
					...
					<div class="col-xs-6 col-sm-4 product-grids">
						<div class="flip-container">
							<div class="flipper agile-products">
								<div class="front">
									<img src='../../images/ccc/<%=c_image.get(v * 5)%>' class="img-responsive" alt="img">
									<div class="agile-product-text">
										<h5><%=c_name.get(v * 5)%></h5>
									</div>
								</div>
								<div class="back">
									<h4><%=Foodstall.get(v * 5) %><br> <%=c_name.get(v * 5)%></h4>
									<p><%=type.get(v * 5)%></p>
									<h6>
										<%=c_c_price.get(v * 5)%><sup>$</sup>
									</h6>
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart"> <input
											type="hidden" name="add" value="1"> <input
											type="hidden" name="w3ls_item" value="<%=c_name.get(v * 5)%>">
										<input type="hidden" name="amount"
											value="<%=c_c_price.get(v * 5)%>">
										<a href="<c:url value='<%="/CCC_condiment/"+c_v_uniformnumbers.get(v*5)+"/" %>'/>"><i class="fa fa-cart-plus" aria-hidden="true"></i>  購物車</a>
										<span class="w3-agile-line"> </span> <a href="#"
											data-toggle="modal" data-target="#myModal1">更多選擇...</a>
									</form>
								</div>
							</div>
						</div>
							...
							<div class="flipper agile-products">
								<div class="front">
									<div class="agile-product-text agile-product-text2">
										<h5><%=c_name.get((v * 5) + 1)%></h5>
									</div>
									<img src='../../images/ccc/<%=c_image.get((v * 5) + 1)%>'
										class="img-responsive" alt="img">
								</div>
								<div class="back">
									<h4><%=Foodstall.get(v * 5+1)%><br> <%=c_name.get((v * 5) + 1)%></h4>
									<p><%=type.get(v * 5+1)%></p>
									<h6>
										<%=c_c_price.get((v * 5) + 1)%><sup>$</sup>
									</h6>
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart"> <input
											type="hidden" name="add" value="1"> <input
											type="hidden" name="w3ls_item"
											value="<%=c_name.get((v * 5) + 1)%>"> <input
											type="hidden" name="amount"
											value="<%=c_c_price.get((v * 5) + 1)%>">
										<a href="<c:url value='<%="/CCC_condiment/"+c_v_uniformnumbers.get(v*5+1)+"/" %>'/>"><i class="fa fa-cart-plus" aria-hidden="true"></i>  購物車</a>
										<span class="w3-agile-line"> </span> <a href="#"
											data-toggle="modal" data-target="#myModal1">更多選擇...</a>
									</form>
								</div>
					...
					<div class="col-xs-6 col-sm-4 product-grids">
						<div class="flip-container">
							<div class="flipper agile-products">
								<div class="front">
									<img src='../../images/ccc/<%=c_image.get((v * 5) + 2)%>'
										class="img-responsive" alt="img">
									<div class="agile-product-text">
										<h5><%=c_name.get((v * 5) + 2)%></h5>
									</div>
								</div>
								<div class="back">
									<h4><%=Foodstall.get(v * 5+2)%><br> <%=c_name.get((v * 5) + 2)%></h4>
									<p><%=type.get(v * 5+2)%></p>
									<h6>
										<%=c_c_price.get((v * 5) + 2)%><sup>$</sup>
									</h6>
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart"> <input
											type="hidden" name="add" value="1"> <input
											type="hidden" name="w3ls_item"
											value="<%=c_name.get((v * 5) + 2)%>"> <input
											type="hidden" name="amount"
											value="<%=c_c_price.get((v * 5) + 2)%>">
										<a href="<c:url value='<%="/CCC_condiment/"+c_v_uniformnumbers.get(v*5+2)+"/" %>'/>"><i class="fa fa-cart-plus" aria-hidden="true"></i>  購物車</a>
										<span class="w3-agile-line"> </span> <a href="#"
											data-toggle="modal" data-target="#myModal1">更多選擇...</a>
									</form>
								</div>
					...
					<div class="col-xs-6 col-sm-6 product-grids">
						<div class="flip-container flip-container1">
							<div class="flipper agile-products">
								<div class="front">
									<div class="agile-product-text agile-product-text2">
										<h5><%=c_name.get((v * 5) + 3)%></h5>
									</div>
									<img src='../../images/ccc/<%=c_image.get((v * 5) + 3)%>'
										class="img-responsive" alt="img">
								</div>
								<div class="back">
									<h4><%=Foodstall.get(v * 5+3)%><br> <%=c_name.get((v * 5) + 3)%></h4>
									<p><%=type.get(v * 5+3)%></p>
									<h6>
										<%=c_c_price.get((v * 5) + 3)%><sup>$</sup>
									</h6>
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart"> <input
											type="hidden" name="add" value="1"> <input
											type="hidden" name="w3ls_item"
											value="<%=c_name.get((v * 5) + 3)%>"> <input
											type="hidden" name="amount"
											value="<%=c_c_price.get((v * 5) + 3)%>">
										<a href="<c:url value='<%="/CCC_condiment/"+c_v_uniformnumbers.get(v*5+3)+"/" %>'/>"><i class="fa fa-cart-plus" aria-hidden="true"></i>  購物車</a>
										<span class="w3-agile-line"> </span> <a href="#"
											data-toggle="modal" data-target="#myModal1">更多選擇...</a>
									</form>
								</div>
					...
					<div class="col-xs-6 col-sm-6 product-grids">
						<div class="flip-container flip-container1">
							<div class="flipper agile-products">
								<div class="front">
									<img src='../../images/ccc/<%=c_image.get((v * 5) + 4)%>'
										class="img-responsive" alt="img">
									<div class="agile-product-text">
										<h5><%=c_name.get((v * 5) + 4)%></h5>
									</div>
								</div>
								<div class="back">
									<h4><%=Foodstall.get(v * 5+4)%><br> <%=c_name.get((v * 5) + 4)%></h4>
									<p><%=type.get(v * 5+4)%></p>
									<h6>
										<%=c_c_price.get((v * 5) + 4)%><sup>$</sup>
									</h6>
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart"> <input
											type="hidden" name="add" value="1"> <input
											type="hidden" name="w3ls_item"
											value="<%=c_name.get((v * 5) + 4)%>"> <input
											type="hidden" name="amount"
											value="<%=c_c_price.get((v * 5) + 4)%>">
										<a href="<c:url value='<%="/CCC_condiment/"+c_v_uniformnumbers.get(v*5+4)+"/" %>'/>"><i class="fa fa-cart-plus" aria-hidden="true"></i>  購物車</a>
										<span class="w3-agile-line"> </span> <a href="#"
											data-toggle="modal" data-target="#myModal1">更多選擇...</a>
									</form>
								</div>
					...
					<div class="col-xs-6 col-sm-4 product-grids">
						<div class="flip-container">
							<div class="flipper agile-products">
								<div class="front">
									<img src='../../images/ccc/<%=c_image.get((a * 5))%>'
										class="img-responsive" alt="img">
									<div class="agile-product-text">
										<h5><%=c_name.get((a * 5))%></h5>
									</div>
								</div>
								<div class="back">
									<h4><%=Foodstall.get(a * 5)%><br> <%=c_name.get((a * 5))%></h4>
									<p><%=type.get(a * 5)%></p>
									<h6>
										<%=c_c_price.get((a * 5))%><sup>$</sup>
									</h6>
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart"> <input
											type="hidden" name="add" value="1"> <input
											type="hidden" name="w3ls_item"
											value="<%=c_name.get((a * 5))%>"> <input
											type="hidden" name="amount"
											value="<%=c_c_price.get((a * 5))%>">
										<a href="<c:url value='<%="/CCC_condiment/"+c_v_uniformnumbers.get(a*5)+"/" %>'/>"><i class="fa fa-cart-plus" aria-hidden="true"></i>  購物車</a>
										<span class="w3-agile-line"> </span> <a href="#"
											data-toggle="modal" data-target="#myModal1">更多選擇...</a>
									</form>
								</div>
					...
					<div class="col-xs-6 col-sm-4 product-grids">
						<div class="flip-container">
							<div class="flipper agile-products">
								<div class="front">
									<div class="agile-product-text agile-product-text2">
										<h5><%=c_name.get((a * 5) + 1)%></h5>
									</div>
									<img src='../../images/ccc/<%=c_image.get((a * 5) + 1)%>'
										class="img-responsive" alt="img">
								</div>
								<div class="back">
									<h4><%=Foodstall.get(a * 5+1) %><br> <%=c_name.get((a * 5) + 1)%></h4>
									<p><%=type.get(a * 5+1)%></p>
									<h6>
										<%=c_c_price.get((a * 5) + 1)%><sup>$</sup>
									</h6>
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart"> <input
											type="hidden" name="add" value="1"> <input
											type="hidden" name="w3ls_item"
											value="<%=c_name.get((a * 5) + 1)%>"> <input
											type="hidden" name="amount"
											value="<%=c_c_price.get((a * 5) + 1)%>">
										<a href="<c:url value='<%="/CCC_condiment/"+c_v_uniformnumbers.get(a*5+1)+"/" %>'/>"><i class="fa fa-cart-plus" aria-hidden="true"></i>  購物車</a>
										<span class="w3-agile-line"> </span> <a href="#"
											data-toggle="modal" data-target="#myModal1">更多選擇...</a>
									</form>
								</div>
					...
					<div class="col-xs-6 col-sm-4 product-grids">
						<div class="flip-container">
							<div class="flipper agile-products">
								<div class="front">
									<img src='../../images/ccc/<%=c_image.get((a * 5) + 2)%>'
										class="img-responsive" alt="img">
									<div class="agile-product-text">
										<h5><%=c_name.get((a * 5) + 2)%></h5>
									</div>
								</div>
								<div class="back">
									<h4><%=Foodstall.get(a * 5+2) %><br> <%=c_name.get((a * 5) + 2)%></h4>
									<p><%=type.get(a * 5+2)%></p>
									<h6>
										<%=c_c_price.get((a * 5) + 2)%><sup>$</sup>
									</h6>
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart"> <input
											type="hidden" name="add" value="1"> <input
											type="hidden" name="w3ls_item"
											value="<%=c_name.get((a * 5) + 2)%>"> <input
											type="hidden" name="amount"
											value="<%=c_c_price.get((a * 5) + 2)%>">
										<a href="<c:url value='<%="/CCC_condiment/"+c_v_uniformnumbers.get(a*5+2)+"/" %>'/>"><i class="fa fa-cart-plus" aria-hidden="true"></i>  購物車</a>
										<span class="w3-agile-line"> </span> <a href="#"
											data-toggle="modal" data-target="#myModal1">更多選擇...</a>
									</form>
								</div>
					...
					<div class="col-xs-6 col-sm-6 product-grids">
						<div class="flip-container flip-container1">
							<div class="flipper agile-products">
								<div class="front">
									<div class="agile-product-text agile-product-text2">
										<h5><%=c_name.get((a * 5) + 3)%></h5>
									</div>
									<img src='../../images/ccc/<%=c_image.get((a * 5) + 3)%>'
										class="img-responsive" alt="img">
								</div>
								<div class="back">
									<h4><%=Foodstall.get(a * 5+3) %><br> <%=c_name.get((a * 5) + 3)%></h4>
									<p><%=type.get(a * 5+3)%></p>
									<h6>
										<%=c_c_price.get((a * 5) + 3)%><sup>$</sup>
									</h6>
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart"> <input
											type="hidden" name="add" value="1"> <input
											type="hidden" name="w3ls_item"
											value="<%=c_name.get((a * 5) + 3)%>"> <input
											type="hidden" name="amount"
											value="<%=c_c_price.get((a * 5) + 3)%>">
										<a href="<c:url value='<%="/CCC_condiment/"+c_v_uniformnumbers.get(a*5+3)+"/" %>'/>"><i class="fa fa-cart-plus" aria-hidden="true"></i>  購物車</a>
										<span class="w3-agile-line"> </span> <a href="#"
											data-toggle="modal" data-target="#myModal1">更多選擇...</a>
									</form>
								</div>
				...
				<div class="slider-left">
					<h4>全站搜索</h4>            
						<div class="row row1 scroll-pane">
							<form action="../../CCC_BE" method="POST">
				...
				<div class="related-row">
					...
					<div class="galry-like">
						<a href="#" data-toggle="modal" data-target="#myModal1"><img
							src="../../images/ccc/images/a55.jpg" class="img-responsive"
							alt="img"></a>
					</div>
				</div>
			</div>
				...
				<div class="col-md-9 spldishes-grids">
					...
					<div id="owl-demo"
						...
						<a href="products.html" class="item g1"> <img class="lazyOwl"
							src="../../images/ccc/images/a1.png" title="Our latest gallery"
							alt="" />
							...
							src="../../images/ccc/images/a2.png" title="Our latest gallery"
							alt="" />
							<div class="agile-dish-caption">
								<h4>鹽烤杏鮑菇</h4>
							...
							src="../../images/ccc/images/a3.png" title="Our latest gallery"
							alt="" />
							<div class="agile-dish-caption">
								<h4>大昌沙拉船</h4>
							...
							src="../../images/ccc/images/a4.png" title="Our latest gallery"
							alt="" />
							<div class="agile-dish-caption">
								<h4>最老牌苦茶</h4>
							...
							src="../../images/ccc/images/a5.png" alt="" />
							<div class="agile-dish-caption">
								<h4>料理長胡椒蝦</h4>
								<span>蝦膏鮮黃蝦肉飽滿</span>
							</div>
						</a> <a href="products.html" class="item g1"> <img class="lazyOwl"
							src="../../images/ccc/images/a6.png" title="Our latest gallery"
							alt="" />
							<div class="agile-dish-caption">
								<h4>火烤厚切牛排</h4>
							...
							src="../../images/ccc/images/a7.png" title="Our latest gallery"
							alt="" />
							<div class="agile-dish-caption">
								<h4>雅米花生捲冰淇淋</h4>
							...
							src="../../images/ccc/images/a8.png" title="Our latest gallery"
							alt="" />
							<div class="agile-dish-caption">
								<h4>馥陽鍋貼水餃專賣店</h4>
				...
				<section>
					<div class="modal-body">
						<div class="col-md-5 modal_body_left">
							<img src="../../images/ccc/images/a55.jpg" alt=" "
