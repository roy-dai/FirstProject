...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">夜總匯</a>
            <!-- Sidebar Toggle-->
            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            <div class="sb-sidenav-menu-heading">會員資料</div>
                            <a class="nav-link" href="<c:url value='/admin/center'/>">
        ...
        <script src="../roy/demo/chart-pie-demo.js"></script>
