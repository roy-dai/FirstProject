			...
			<div class="w3ls-header"><!-- header-one --> 
				<div class="container">
					...
					<div class="w3ls-header-right">
						<ul> 
							<li class="head-dpdn">
								<i class="fa fa-phone" aria-hidden="true"></i> 聯絡我們: +886 987 987987 
							</li> 
							<li class="head-dpdn">
								<a href="login.html"><i class="fa fa-sign-in" aria-hidden="true"></i> 登入</a>
							</li> 
							<li class="head-dpdn">
								<a href="signup.html"><i class="fa fa-user-plus" aria-hidden="true"></i> 註冊會員</a>
							</li> 
							<li class="head-dpdn">
								<a href="offers.html"><i class="fa fa-gift" aria-hidden="true"></i> Offers</a>
							</li> 
							<li class="head-dpdn">
								<a href="help.html"><i class="fa fa-question-circle" aria-hidden="true"></i> 客服中心</a>
							</li>
						</ul>
					</div>
				...
				<div class="container">
					<nav class="navbar navbar-default">
						...
						<div class="navbar-header w3l_logo">
							...
							<h1><a href="index.html">YA!夜總匯<span>全台最完善夜市</span></a></h1>
						</div> 
						<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
							<ul class="nav navbar-nav navbar-right">
								...
								<li><a href="about.html">關於YA!夜總匯</a></li> 
	...
	<div class="cart-item-list">
  	...
  	<div class="cart-floatbar">
        ...
        <div class="toolbar-right">
          ...
          <input type="submit" class="btn-area"  value="確認付款" >
 </form>         
        </div>
...
$(function(){
	...
	xhr.open('GET', "<c:url value='/findMemberOrder' />", true);
	xhr.send();
	...
	function showData(textObj) {
		...
		console.log(obj.order_Id[i]);
		console.log(obj.order_No[i]);
		console.log(obj.original_Cart_Id[i]);
		console.log(obj.buyer[i]);
		console.log(obj.total_Price[i]);
		console.log(obj.order_Date[i]);
		console.log(obj.order_State[i]);
		console.log(obj.v_id[i]);
		console.log(obj.qty[i]);
		console.log(obj.c_name[i]);
		console.log(obj.c_image[i]);
		
		
			segment += '<div class="cart-item check-cart-item">'
			segment += '<div class="p-checkbox">'
			segment += '<input type="checkbox" name="box" id="' + obj.order_Id[i] + '"  value="' + i + '" class="j-checkbox">' //這樣設計是為了可以讓後端讀取多個以勾選資料(先轉換成另外一個形式的id)
			segment += '<input type="hidden" name="boxx" value="' + obj.order_Id[i] + '">'//使用input做hidden型態 , 裡面埋購物車id , name="boxx"讓我取value 
			segment += '</div>'
			segment += '<div class="p-goods">'
			segment += '<div class="p-images">'
			segment += '<img src="images/ccc/'+ obj.c_image[i] + '" alt="" width="90px" height="90px">'
			segment += '</div>'
			segment += '<div class="p-msg">' + obj.c_name[i] + '</div>'
			segment += '</div>'
			segment += '<div class="p-price">$' + obj.total_Price[i] + '</div>'
			segment += '<div class="p-num">'
			segment += '<div class="quantity-form">'
			segment += '<a href="javascript:;" class="decrement">-</a>'
			segment += '<input id="' + 'qtyOfOrder'+ obj.original_Cart_Id[i] + '"  name="qty" type="text" class="itxt" value="' + obj.qty[i]  +'">'
			segment += '<a href="javascript:;" class="increment">+</a>'
			segment += '</div>'
			segment += '</div>'
			segment += '<div class="p-sum">$' + obj.total_Price[i] + '</div>'
			segment += '<i class="fas fa-trash-alt"></i>'
			segment += '<div class="p-action"><a href="<c:url value="/mike_remove/'+ obj.original_Cart_Id[i] +'"/>">移除</a></div>'
			segment += '</div>' 
				...
				<div class="col-md-9 spldishes-grids">
					...
					<div id="owl-demo" class="owl-carousel text-center agileinfo-gallery-row">
						<a href="products.html" class="item g1">
							<img class="lazyOwl" src="FrontPage/images/g1.jpg" title="Our latest gallery" alt=""/>
						...
						<a href="products.html" class="item g1">
							<img class="lazyOwl" src="FrontPage/images/g2.jpg" title="Our latest gallery" alt=""/>
							<div class="agile-dish-caption">
								<h4>Duis congue</h4>
								<span>Neque porro quisquam est qui dolorem </span>
							</div>
						...
						<a href="products.html" class="item g1">
							<img class="lazyOwl" src="FrontPage/images/g3.jpg" title="Our latest gallery" alt=""/>
							<div class="agile-dish-caption">
								<h4>Duis congue</h4>
								<span>Neque porro quisquam est qui dolorem </span>
							</div>
						...
						<a href="products.html" class="item g1">
							<img class="lazyOwl" src="FrontPage/images/g4.jpg" title="Our latest gallery" alt=""/>
							<div class="agile-dish-caption">
								<h4>Duis congue</h4>
								<span>Neque porro quisquam est qui dolorem </span>
							</div>
						...
						<a href="products.html" class="item g1">
							<img class="lazyOwl" src="FrontPage/images/g5.jpg" alt=""/>
							<div class="agile-dish-caption">
								<h4>Duis congue</h4>
								<span>Neque porro quisquam est qui dolorem </span>
							</div>
	...
	<div class="subscribe agileits-w3layouts"> 
		<div class="container">
			...
			<div class="col-md-6 subscribe-right">
				...
				<img src="FrontPage/images/i1.png" class="sub-w3lsimg" alt=""/>
			</div>
			<div class="clearfix"> </div> 
		</div>
	</div>
