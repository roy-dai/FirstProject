...
<body> 
	...
	<div class="offers about"> 
		<div class="container"> 
		<iframe width="1150" height="800" src="https://www.youtube.com/embed/<%=film.get(size) %>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
	</div> 
	</div>
	...
	<div class="offers about"> 
		...
		<%for(int x = 0;x<z;x++){ %>	
			<div class="offers-wthreerow"  style="background:url(../css/ccc/index/images/<%=photo.get(x)%>)no-repeat 0px">  
				<div class="offers-right"> 
					<h5><%=name.get(x)%><br><%=performance.get(x) %></h5>
